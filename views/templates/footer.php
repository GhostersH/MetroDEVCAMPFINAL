    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                MetropolitanWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva a cabo de forma presencial y en línea.
            </p>
        </div>
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/GhostersH">
